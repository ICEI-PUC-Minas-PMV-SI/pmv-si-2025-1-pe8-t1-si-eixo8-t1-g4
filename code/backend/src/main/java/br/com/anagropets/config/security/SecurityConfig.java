...
import br.com.anagropets.config.CorsProperties;
...
public class SecurityConfig {
	...
	// ✅ Corrige CORS para aceitar frontend em https://localhost:4200 e
	// https://www.anagropets.com.br
	@Bean
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.cors(cors -> cors.configurationSource(corsConfigurationSource())).csrf(csrf -> csrf.disable())
				.authorizeHttpRequests(auth -> auth.requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
						.requestMatchers("/auth/**", "/cadastro", "/v3/api-docs/**", "/swagger-ui/**",
								"/swagger-ui.html", "/swagger-resources/**", "/configuration/**", "/webjars/**")
