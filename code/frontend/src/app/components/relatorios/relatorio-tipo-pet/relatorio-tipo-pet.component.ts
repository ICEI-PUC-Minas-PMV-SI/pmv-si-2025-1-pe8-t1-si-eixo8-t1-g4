...
@Component({
  selector: 'app-relatorio-tipo-pet',
  imports: [BaseChartDirective, MatTableModule, MatButtonModule, MatIconModule],
  templateUrl: './relatorio-tipo-pet.component.html',
  styleUrl: './relatorio-tipo-pet.component.scss',
})
export class RelatorioTipoPetComponent {
  chartLabels: string[] = [];
  chartData: number[] = [];
  ...
  constructor(
    private readonly dialogRef: MatDialogRef<RelatorioTipoPetComponent>,
  ...
  ngOnInit() {
    this.relatoriosService
      ...
      .subscribe((res: any) => {
        ...
        this.chartLabels = objetos.map((obj: any) => obj.tipo);
